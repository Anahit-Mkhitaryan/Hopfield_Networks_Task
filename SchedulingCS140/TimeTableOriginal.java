...
public class TimeTableOriginal extends JFrame implements ActionListener {
	...
	public TimeTableOriginal() {
		super("Dynamic Time Table Original");
		setSize(500, 800);
		setLayout(new FlowLayout());

		Logger.initLogger("TimeTableOriginalLog.txt");
	...
	public void actionPerformed(ActionEvent click) {
		...
		case 1:
			...
			String iterations = field[3].getText();
			for (int iteration = 1; iteration <= Integer.parseInt(iterations); iteration++) {
			...
			System.out.println("Shift = " + field[4].getText() + "\tMin clashes = " + min + "\tat step " + step + "\tIterations " + iterations);
			Logger.log("Shift = " + field[4].getText() + "\tMin clashes = " + min + "\tat step " + step + "\tIterations " + iterations);
